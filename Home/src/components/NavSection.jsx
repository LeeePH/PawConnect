...
import { Moon, Sun, User, Lock, Menu, X, Eye, EyeOff, 
  Mail, Check, AlertCircle, CheckCircle, XCircle, Info, FileText, Shield } from "lucide-react"
...
const NavSection = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Then redirect with token and userData in URL
        setTimeout(() => {
          const userDataString = encodeURIComponent(JSON.stringify(data.user));
          const tokenString = encodeURIComponent(data.token);
          window.location.href = `http://localhost:5174/?token=${tokenString}&userData=${userDataString}`;
        }, 2000);
      }
    } catch (error) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setShowRegisterModal(false);
        // Removed: showNotification('success', data.message);
      }
    } catch (error) {
      showNotification('error', 'Error connecting to the server.');
    } finally {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      setForgotPasswordStatus('error');
      setForgotPasswordMessage(error.message || 'Error sending reset instructions');
    } finally {
          ...
          <div className="md:hidden bg-white dark:bg-gray-900 shadow-lg animate-fadeIn">
            <div className="px-6 py-4 space-y-3 border-t border-gray-200 dark:border-gray-700">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 mb-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-white rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium"
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-sm text-[#6D712E] hover:underline"
                    >
                      Forgot password?
                    </button>
                  </div>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="email"
                      className={`block w-full pl-10 pr-10 py-3 border ${
                        isCheckingAvailability ? "border-gray-300 dark:border-gray-600 focus:ring-gray-300 dark:focus:ring-gray-600" :
                        isValidEmail === true
                          ? "border-green-500 focus:ring-green-500 focus:border-green-500"
                          : isValidEmail === false
                            ? "border-red-500 focus:ring-red-500 focus:border-red-500"
                  ...
                  <div id="email-feedback" className="text-xs mt-1">
                    {isTypingEmail ? (
                      ...
                      <p className="text-red-500">Please enter a valid email format (e.g., example@domain.com)</p>
                    ) : (
                ...
                <button
                  ...
                  className={`w-full mt-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all ${
                    passwordStrength >= 3 && isValidEmail === true && usernameAvailable === true && !isRegistering
                      ? "bg-[#6D712E] hover:bg-[#7D812E] text-white"
                      : "bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed"
                  }`}
                  disabled={!(passwordStrength >= 3 && isValidEmail === true && usernameAvailable === true) || isRegistering}
                  style={isRegistering ? { cursor: 'wait', opacity: 0.7 } : {}}
                >
                  {isRegistering ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl animate-fadeIn">
            <div className="relative p-6">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Forgot Password</h3>
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full bg-[#6D712E] hover:bg-[#7D812E] text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center ${
                    isResettingPassword ? 'opacity-75 cursor-not-allowed' : ''
                  }`}
                >
                  {isResettingPassword ? (
                    <>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  <button
                    ...
                    className="text-[#6D712E] font-medium hover:underline"
                  >
                    Back to Login
                  </button>
                </p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-6 shadow-2xl animate-fadeIn">
            ...
            {verificationStatus === "success" && (
              <div className="flex flex-col items-center space-y-5">
                ...
                <div className="space-y-2 max-w-xs mx-auto">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Click the button below to proceed to the login.
                  </p>
                </div>
            ...
            {verificationStatus === "error" && (
              <div className="flex flex-col items-center space-y-5">
                ...
                <div className="space-y-2 max-w-xs mx-auto">
                  <p className="text-gray-700 dark:text-gray-300 font-medium">
                    {forgotPasswordMessage || "Error verifying email. Please try again."}
                  </p>
                </div>

                <div className="pt-4 w-full">
                  <button
                    onClick={() => setForgotPasswordStatus(null)}
                    className="w-full px-4 py-3 bg-[#6D712E] hover:bg-[#7D812E] text-white rounded-xl font-medium transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center"
                  >
                    <span>Close</span>
                  </button>
