...
import { User, Lock, X, Eye, EyeOff, Mail, Check, AlertCircle, CheckCircle, XCircle, Info, FileText, Shield } from "lucide-react"
  ...
  return (
    ...
    <section id="pet" className="bg-gray-100 dark:bg-gray-900 py-10 mt-5">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-center text-3xl font-bold mb-5 uppercase">Our Adoptable <span>Pets</span></h1>
        ...
        <div className="flex justify-center">
          <button
            className="px-5 py-3 border bg-[#6D712E] text-white dark:bg-[#7D812E] dark:border-green-900 text-center rounded-md mt-7 duration-300 hover:bg-black"
